...
#define SPI_MODE_0 (SPI_MASTER | SPI_L_TO_H | SPI_XMIT_L_TO_H | SPI_CLK_DIV_16 | SPI_SAMPLE_AT_MIDDLE)
...
//! and switches the rfm70 to receive mode.
...
//! RFM70_MAX_PACKET_LEN (32).
//! 
//! The RFM70 must be in receive mode.
